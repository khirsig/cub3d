...
/*   Updated: 2021/12/21 09:53:37 by khirsig          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	player_movement(t_data *data)
{
	...
	temp_y = (data->player.y_pos + data->player.dirY * data->player.speed) + 0.08;
	temp_x = (data->player.x_pos + data->player.dirX * data->player.speed) + 0.08;
	...
	temp_y = (data->player.y_pos + data->player.planeY * data->player.speed) + 0.08;
	temp_x = (data->player.x_pos + data->player.planeX * data->player.speed) + 0.08;
